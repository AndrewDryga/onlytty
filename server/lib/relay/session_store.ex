defmodule Relay.SessionStore do
  ...
  `Relay.Session` GenServer per session, started under a `DynamicSupervisor`
  and registered by id in `Relay.Registry`. Nothing is ever persisted.
  ...
  defp idle_ms do
    Application.get_env(:relay, :idle_timeout_ms, 10 * 60 * 1000)
  end
end
