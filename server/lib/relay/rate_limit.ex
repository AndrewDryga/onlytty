defmodule Relay.RateLimit do
  ...
  in `:test`). See `RELAY_RATELIMIT_MAX` / `RELAY_RATELIMIT_WINDOW` in `runtime.exs`.
  """

  use GenServer

  @table :relay_rate_limit
  ...
  defp max_requests, do: Application.get_env(:relay, :rate_limit_max, 30)
  defp window_ms, do: Application.get_env(:relay, :rate_limit_window_ms, 60_000)
end
